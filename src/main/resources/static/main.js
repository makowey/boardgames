    ...
    BoardGameListComponent.prototype.applyFilter = function (filterValue) {
        ...
        if (this.currentFilter.startsWith("@") &&
            ...
            this.boardGameService.findCollections(this.boardGames.filter)
                ...
                if (!_this.boardGames.filter.endsWith("\w"))
